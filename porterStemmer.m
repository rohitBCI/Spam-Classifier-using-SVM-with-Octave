...
% cvc(j) is TRUE <=> j-2,j-1,j has the form consonant - vowel - consonant and also if the second c is not w,x or y
...
% sets (j+1),...k to the characters in the string s, readjusting k accordingly.
